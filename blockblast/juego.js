...
var ASM_CONSTS = {
  92952: () => { if (document.fullscreenElement) return 1; },  
 92998: () => { return Module.canvas.width; },  
 93030: () => { return parseInt(Module.canvas.style.width); },  
 93078: () => { document.exitFullscreen(); },  
 93105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93178: () => { if (document.fullscreenElement) return 1; },  
 93224: () => { return Module.canvas.width; },  
 93256: () => { return screen.width; },  
 93281: () => { document.exitFullscreen(); },  
 93308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93441: () => { return window.innerWidth; },  
 93467: () => { return window.innerHeight; },  
 93494: () => { if (document.fullscreenElement) return 1; },  
 93540: () => { return Module.canvas.width; },  
 93572: () => { return parseInt(Module.canvas.style.width); },  
 93620: () => { if (document.fullscreenElement) return 1; },  
 93666: () => { return Module.canvas.width; },  
 93698: () => { return screen.width; },  
 93723: () => { return window.innerWidth; },  
 93749: () => { return window.innerHeight; },  
 93776: () => { if (document.fullscreenElement) return 1; },  
 93822: () => { return Module.canvas.width; },  
 93854: () => { return screen.width; },  
 93879: () => { document.exitFullscreen(); },  
 93906: () => { if (document.fullscreenElement) return 1; },  
 93952: () => { return Module.canvas.width; },  
 93984: () => { return parseInt(Module.canvas.style.width); },  
 94032: () => { document.exitFullscreen(); },  
 94059: ($0) => { Module.canvas.style.opacity = $0; },  
 94097: () => { return screen.width; },  
 94122: () => { return screen.height; },  
 94148: () => { return window.screenX; },  
 94175: () => { return window.screenY; },  
 94202: () => { return window.devicePixelRatio; },  
 94238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94291: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94342: () => { Module.canvas.style.cursor = 'none'; },  
 94379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94635: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94686: () => { if (document.pointerLockElement) return 1; },  
 94733: () => { if (document.fullscreenElement) return 1; },  
 94779: () => { return window.innerWidth; },  
 94805: () => { return window.innerHeight; }
};
